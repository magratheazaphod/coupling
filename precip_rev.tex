...
%DELETE LATER - if so inclined, could attempt to turn up another citation or two about hypothesized links between the ISM and EASM. The Liu paper is not a great paper.			
